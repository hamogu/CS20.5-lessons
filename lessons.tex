...
\begin{figure*}
	\centering
	\includegraphics[width=0.49\linewidth]{timingCS20.pdf}
        \includegraphics[width=0.49\linewidth]{timingCS205.pdf}
	\caption{Timing of registration and abstract submission. \emph{left:} Cool Stars 20 in person in Boston, MA, USA, \emph{right:} Cool Stars 205., virtually.}
	\label{fig:timing}
\end{figure*}
